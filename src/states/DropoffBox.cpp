...
void DropoffBox::handlePhaseChange(DemoController & ctl)
{
    ...
    switch (m_phase)
    {
        case Phase::Init: m_phase = Phase::LowerBox;
            currentPhaseName = "LowerBox";
            break;
        case Phase::LowerBox: if (m_contactAdded)
            {
                ctl.clearContacts();
                m_contactAdded = false;
            }
            ...
            break;
        case Phase::DropBox: m_phase = Phase::Retreat;
            currentPhaseName = "Retreat";
            break;
        case Phase::Retreat: m_phase = Phase::Finished;
        ...
        case (Phase::Retreat):
        {
            ...
            m_rightGripperTask->target(
                                       ctl.robot().frame(m_robotReferenceFrame),
                                       {
                                           ...
                                           m_rightDropPositionRobot + m_rightGraspOffsetRobot +
...
void DropoffBox::addToGui(DemoController & ctl)
{
    ...
    ctl.gui()->addElement(
                          ...
                          mc_rtc::gui::ArrayInput(
                                                  ...
                                                  [this]
                                                  {
                                                      return m_leftDropPositionRobot;
                                                  },
                                                  [this](const Eigen::Vector3d & value)
                                                  {
                                                      m_leftDropPositionRobot = value;
                                                  }
                                                 ),
                          mc_rtc::gui::ArrayInput(
                                                  ...
                                                  [this]
                                                  {
                                                      return m_rightDropPositionRobot;
                                                  },
                                                  [this](const Eigen::Vector3d & value)
                                                  {
                                                      m_rightDropPositionRobot = value;
                                                  }
                                                 )
                         );
